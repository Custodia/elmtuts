...
Elm.Widget.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var update = F2(function (action,model) {    var _p0 = action;return _U.update(model,{count: model.count + 1});});
   ...
   return _elm.Widget.values = {_op: _op,Model: Model,initialModel: initialModel,Increase: Increase,view: view,update: update};
};
Elm.Main = Elm.Main || {};

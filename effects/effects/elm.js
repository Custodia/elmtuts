...
Elm.Main.make = function (_elm) {
   ...
   var oneActionAddress = A2($Signal.forwardTo,actionsMailbox.address,function (action) {    return _U.list([action]);});
   ...
   var modelAndFxSignal = function () {
      ...
      var modelAndFx = F2(function (action,_p1) {    var _p2 = _p1;return A2(update,action,_p2._0);});
      var modelAndManyFxs = F2(function (actions,_p3) {
         var _p4 = _p3;
         return A3($List.foldl,modelAndFx,{ctor: "_Tuple2",_0: _p4._0,_1: $Effects.none},actions);
      });
      return A3($Signal.foldp,modelAndManyFxs,initial,actionsMailbox.signal);
   }();
   var modelSignal = A2($Signal.map,$Basics.fst,modelAndFxSignal);
   var fxSignal = A2($Signal.map,$Basics.snd,modelAndFxSignal);
   var taskSignal = A2($Signal.map,$Effects.toTask(actionsMailbox.address),fxSignal);
   var runner = Elm.Native.Task.make(_elm).performSignal("runner",taskSignal);
